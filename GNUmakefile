...
triangular_x64:		triangularHeisenberg.x64 triangularHeisenbergelasticonly.x64 triangularHeisenbergphononsonly.x64 triangularHeisenberg_print.x64 triangularHeisenbergX.x64 triangularHeisenbergelasticonlyX.x64 triangularHeisenbergphononsonlyX.x64 triangularHeisenbergX_print.x64
triangular_fox:		triangularHeisenberg.fox triangularHeisenbergelasticonly.fox triangularHeisenbergphononsonly.fox triangularHeisenberg_print.fox triangularHeisenbergX.fox triangularHeisenbergelasticonlyX.fox triangularHeisenbergphononsonlyX.fox triangularHeisenbergX_print.fox
triangular_saga:		triangularHeisenberg.saga triangularHeisenbergelasticonly.saga triangularHeisenbergphononsonly.saga triangularHeisenberg_print.saga triangularHeisenbergX.saga triangularHeisenbergelasticonlyX.saga triangularHeisenbergphononsonlyX.saga triangularHeisenbergX_print.saga
