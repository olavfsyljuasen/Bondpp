...
triangularHeisenberg.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DHEXAGONALBRAVAISLATTICE -DNSUBLATTICES=1 -DTRIANGULARPHONONS -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DFFTS_INPLACE -c -o $@ $<
