...
squareHeisenberg.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -c -o $@ $<


squareHeisenbergomit.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DOMITPHONONCONT -DFFTS_INPLACE -c -o $@ $<

squareHeisenberg_print.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DPRINTPHONONS -c -o $@ $<

squareHeisenberg_rnd.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DRANDOMINITIALIZATION -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -c -o $@ $<

squareHeisenbergelastic.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DELASTICONLY -DOMITPHONONCONT -c -o $@ $<


squareHeisenbergelasticclamped0.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DELASTICONLY -DOMITPHONONCONT -DONEEPSILONCOMPONENTCLAMPED -DEPSILONCOMPONENTCLAMPED=0 -c -o $@ $<
...
squareHeisenbergnoelastic.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DNOELASTIC -c -o $@ $<


squareHeisenbergnophonons.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DSIMPLECUBICBRAVAISLATTICE -DNSUBLATTICES=1 -DSQUAREPHONONS -DSQUARELATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DRANDOMINITIALIZATION -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DOMITPHONONCONT -DOMITELASTICCONT -c -o $@ $<
...
triangularHeisenberg.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DHEXAGONALBRAVAISLATTICE -DNSUBLATTICES=1 -DTRIANGULARPHONONS -DHEXAGONALLATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -c -o $@ $<

triangularHeisenbergnoelastic.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DHEXAGONALBRAVAISLATTICE -DNSUBLATTICES=1 -DTRIANGULARPHONONS -DHEXAGONALLATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DNOELASTIC -c -o $@ $<

triangularHeisenbergelasticonly.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DHEXAGONALBRAVAISLATTICE -DNSUBLATTICES=1 -DTRIANGULARPHONONS -DHEXAGONALLATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DELASTICONLY -DOMITPHONONCONT -c -o $@ $<

triangularHeisenberg_print.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DHEXAGONALBRAVAISLATTICE -DNSUBLATTICES=1 -DTRIANGULARPHONONS -DHEXAGONALLATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DPRINTPHONONS -c -o $@ $<

triangularHeisenbergnonothing.o  : $(SOURCES)
	$(CCC) $(CCFLAGS) -DHEXAGONALBRAVAISLATTICE -DNSUBLATTICES=1 -DTRIANGULARPHONONS -DHEXAGONALLATTICE  -DQSPACEDIRECTLATTICE -DPHONONS -DXYDISPLACEMENTS -DUSELASTSIGMA -DFORCEINVERSIONSYMMETRY -DFAKEHEISENBERG -DCPOSITIVE -DNBRRANGE=3 -DFFTS_INPLACE -DOMITPHONONCONT -DOMITELASTICCONT -DNOELASTIC -c -o $@ $<
